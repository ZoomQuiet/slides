...
～base :orange:`CMClub` Let's working together!-)

:Authors: `Zoom.Quiet <zoomquiet+io@gmail.com>`__
:URL:    http://s5.zoomquiet.io/140601-cmclub-sf-io/
...
.. footer:: 
   ...
   `Zoom.Quiet`_ |cc-byncsa15| recommend `Firefox`_ / `Chrome`_ for best experience!

organizer of GDG ZhuHai
======================================================
...
.. container:: handout
    ...
    :orange:`every year` appended 6,000,000 University student |zqeye|
...
.. container:: handout
    ...
    :orange:`every year` graduation 600,000 student as developer |zqeye|
...
.. container:: handout
    ...
    :orange:`in total` 10,000 join GDG |zqeye|
...
.. container:: handout
    ...
    comparison :orange:`every year` 600,000 graduation as developer |zqeye|
...
.. container:: handout
    ...
    comparison :orange:`every year` 600,000 as developer |zqeye|
...
.. container:: handout
    ...
    GDL is non-existent for Chinese |zqeye|
...
.. container:: handout
    ...
    gdgorganizersummit is non-existent for Chinese |zqeye|
...
.. container:: handout
    ...
    G+ is non-existent for Chinese |zqeye|
...
.. container:: handout
    ...
    most pople just only can... |zqeye|
...
.. container:: handout
    ...
    in same time most pople just a litter... |zqeye|
...
.. container:: handout
    ...
    most pople shy ask others... |zqeye|
...
.. _Henry Ford: http://www.brainyquote.com/quotes/quotes/h/henryford121997.html

.. container:: handout

   together make difficulty easy |zqeye|
...
.. container:: handout
    ...
    :orange:`Countries` with GDG chapters |zqeye|
...
.. container:: handout
    ...
    :orange:`Citys`  have GDG chapter |zqeye|
...
.. container:: handout
    ...
    :orange:`non-English`  chapter is |zqeye|
...
.. container:: handout
    ...
    can make Chapters working together? |zqeye|
...
.. container:: handout
    ...
    `[3.30]#ZhuHaiGDG#founded! <http://www.chinagdg.com/thread-1495-1-1.html>`_ |zhgdg|
...
.. container:: handout
     ...
     Chinese habit communication |zhgdg|
...
.. container:: handout
     ...
     as Kanban, coordination community matters  |zhgdg|
...
.. container:: handout
    ...
    base Event make people start learnning/codeing... |zqeye|
...
.. container:: handout
    ...
    after begin, how to make people hold on... |zqeye|
...
continual commonuication with people
=======================================

.. container:: handout

    heart to heart |zqeye|
...
.. container:: handout
    ...
    includ hundreds local people |zhgdg|
...
.. container:: handout
    ...
    exchange Events organizing skill/source |zqeye|
...
.. container:: notes
   ...
   - make great event into loal chapter
   - `L10N`_ event flow/game/words ...
   - make series Brand events
...
.. container:: handout
    ...
    base YouTube API, sharing leanning process... |zqeye|
...
.. _Caption: http://support.google.com/youtube/bin/answer.py?hl=en&answer=2734796

.. container:: notes

   - for GDL great video
   - non-English Chapter Union `Caption`_ it
   - chinese Shy in realy-world, BUT NOT Internet ;-)
...
.. container:: handout
    ...
    base code.google, coding together... |zqeye|
...
.. container:: handout
    ...
    as sister Chapters, volunteers support each other ... |zqeye|
...
.. container:: handout
    ...
    GDGer is all good people,we must came into... |zqeye|
...
.. container:: handout
   ...
   fighting: HTML->JS->PHP->XSL->Py |zqeye|
...
`2004:woodpecker.org <http://www.woodpecker.org.cn/>`__
=================================================================
...
Process Improve @Beijing
====================================

.. container:: handout

   learnning: SINA->CPyUG->SLL |zqeye|
...
.. container:: handout
   ...
   CPyUG growning up and up... |zqeye|
...
.. container:: handout
   ...
   1st PyCon China Double City Party... |zqeye|
...
.. container:: handout
   ...
   121024 1st Pythonic Hackathon ! |zqeye|
...
.. _社区大妈: http://wiki.woodpecker.org.cn/moin/ZoomQuiet
...
`GDG ZhuHai <http://www.chinagdg.com/thread-1329-1-1.html>`_
========================================================================
...
- 140601 fixed for 2014
- 130509 appended points
- 130501 prototype
- 130429 desided
...
:URI:
    http://s5.zoomquiet.io/140601-cmclub-sf-io/
